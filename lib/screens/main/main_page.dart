...
import 'package:noname/screens/catalog/catalog_page.dart';
import 'package:noname/screens/home/home_page.dart';
import 'package:noname/screens/main/bloc/main_bloc.dart';
import 'package:noname/screens/profile/profile_pagee.dart';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MainBloc, MainState>(
      builder: (context, state) {
        ...
        BottomNavigationBarItem(icon: Icon(Icons.call_to_action), label: 'Catalog'),
